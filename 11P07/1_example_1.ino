...
#define _DUTY_NEU 1500  // servo neutral position (90 degree)  1550
...
void loop() {
    ...
    dist_ema = getEMAFiltered(dist_raw, dist_ema);
...
float getEMAFiltered(float targetVal,  float prevVal) 
{
    return (_EMA_ALPHA * targetVal) + ((1 - _EMA_ALPHA) * prevVal);
}